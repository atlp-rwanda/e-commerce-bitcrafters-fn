    ...
    <nav className="navbar-container  w-full border-b-1 p-8 flex-between space-x-2">
      ...
      <div className="nav-icons flex-between hidden tablet:flex">
        <ul className='flex-between space-x-4'>
          ...
          <li >
          <Link to="" className="text-lg"> <CiHeart/></Link>
            </li>
          <li >
          <Link to="" className="text-lg"> <IoCartOutline/></Link>
            </li>
          <li >
          <Link to="" className="text-lg"> <IoNotificationsOutline/></Link>
            </li>
          
        </ul>
      </div>
      <div className=' w-[5%] hidden tablet:flex'>
      <Link to="login" className="text-lg"> <RxAvatar className='text-2xl'/></Link>
      
      </div>
    <button onClick={()=>setIsBurgerShown(!burgerShown)} className='tablet:hidden'>{!burgerShown? <RxHamburgerMenu className='text-3xl '/>:<RxCross2 className='text-3xl '/>}</button>
