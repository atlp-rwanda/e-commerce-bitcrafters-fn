      ...
      <div className="section-container tablet:flex justify-between items-center tablet:px-10">
        ...
        <img src={Star} alt="star1" />
          ...
          <h3 className="hero-text text-3xl phone:text-4xl tablet:text-7xl font-light w-[70%]">
            Elevate your <span className="font- font-light italic underline">market</span> experience
          </h3>
          <p className="w-[80%] tablet:w-[60%] text-sm">Get the latest products on the market at affordable dealsLorem ipsum dolor sit amet consectetur. In eu aliquet orci ac risus lobortis </p>
